                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="hidden-480">
                                                ...
                                                <a href="<?php echo base_url('admin/c_belanja/ubah/'.$row['idProperti']) ?>" class="btn btn-primary btn-minier"><i class="fa fa-pencil-square-o"></i> Ubah</a>

                                                <a href="<?php echo base_url('admin/c_belanja/delete/'.$row['idProperti']) ?>" class="btn btn-danger btn-minier">
