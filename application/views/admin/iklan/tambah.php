<div class="main-content">
    ...
    <div class="page-content">
        <div class="row">
            <form method="post" action="<?php echo base_url('admin/c_ads/post') ?>" enctype="multipart/form-data">
                <input type="hidden" name="publish" value="0" />
                <input type="hidden" name="nonpublish" value="1" />
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="link" placeholder="Link Iklan">
                </div>
